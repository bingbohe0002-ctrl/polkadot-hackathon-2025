...
export interface WorbooTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "GAME_MASTER_ROLE"
...
export interface WorbooToken extends BaseContract {
  connect(runner?: ContractRunner | null): WorbooToken;
  waitForDeployment(): Promise<this>;

  interface: WorbooTokenInterface;
